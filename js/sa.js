...
$(document).ready(function()
{
  ...
  newScript.onload = function() {
    ...
    $('.open-img').attr('src', openImg);
    $('.heart-img').attr('src', heartImg);
...
function setMap() {
  ...
  var marker = new naver.maps.Marker({
    ...
    icon: {
        content: '<div class="text-center" style="color:red;"><b style="background:white;padding:2px">'+overlay_location+'</b><br><img src="'+ heartImg +'" class="main-img"></div>',
